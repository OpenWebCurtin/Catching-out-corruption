...
"""
    PerthExtractor class parses the extracrted XMLData specifically from Perth Council Meeting Minutes documents.
...
class PerthExtractor(CouncilExtractorFactory):
...
# Here
    ...
    def call_remove(self, test_sentences):
        ...
        new_sentences = PerthExtractor.remove_bad_sentences(self)
    ...
    def check_for_repeated_phrases(self, xml_data, current_position):
        ...
        try:
            if(current_position < len(xml_data)):
                ...
                reached_end = False
                # was 20
                while(letter.size == found_size and letter.font == found_font and y_gap <20 and reached_end == False):
